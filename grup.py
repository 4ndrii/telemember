...
for user in users:
    ...
    try:
        ...
        print(re+"Waiting {} seconds".format(SLEEP_TIME_2))
        time.sleep(SLEEP_TIME_2)

    except UserPrivacyRestrictedError:
        print(re+"The user's privacy settings do not allow you to do this. Skipping ...")
        print(re+"Waiting for 5 Seconds ...")
        time.sleep(5)
        
    except errors.FloodWaitError as e:
        print(re+"Akun Telah mencapai Batas add member silahkan kembali setelah 24 jam",e.seconds)
